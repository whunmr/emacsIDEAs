...
import org.hunmr.acejump.command.ObtainAndReplaceArgumentAfterJumpCommand;
import org.hunmr.argument.ArgumentCandidate;

import java.util.IdentityHashMap;
import java.util.Map;

public class AceJumpObtainThenReplaceArgumentAction extends AbstractAceJumpArgumentAction {
    @Override
    protected CommandAroundJump createCommand(Editor editor, IdentityHashMap<Editor, Map<Integer, ArgumentCandidate>> targets) {
        return new ObtainAndReplaceArgumentAfterJumpCommand(editor, targets);
    }
}
