...
public class AceJumpObtainThenReplaceBeforeArgumentsAction extends AbstractAceJumpArgumentSliceRangeAction {
    @Override
    ...
    protected CommandAroundJump createCommand(Editor editor, Class<? extends Selector> selectorClass) {
        return new ObtainAndPasteRangeAfterJumpCommand(editor, selectorClass);
    }
}
