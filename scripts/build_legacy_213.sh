...
LOCATION_TEST_SOURCES="$ROOT_DIR/src/org/hunmr/location/CollectedLocationContext.java $ROOT_DIR/src/org/hunmr/location/CollectedLocationFormatter.java $ROOT_DIR/src/org/hunmr/location/CollectedUsageFormatter.java $ROOT_DIR/src/org/hunmr/location/CollectedPromptFormatter.java $ROOT_DIR/src/org/hunmr/location/CollectedCallHierarchyFormatter.java"
...
"$JAVA_BIN" -cp "$TEST_CLASS_DIR" org.hunmr.location.CollectedLocationFormatterTestRunner
"$JAVA_BIN" -cp "$TEST_CLASS_DIR" org.hunmr.location.CollectedUsageFormatterTestRunner
"$JAVA_BIN" -cp "$TEST_CLASS_DIR" org.hunmr.location.CollectedCallHierarchyFormatterTestRunner
