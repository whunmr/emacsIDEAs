...
LOCATION_TEST_SOURCES="$ROOT_DIR/src/org/hunmr/location/CollectedLocationContext.java $ROOT_DIR/src/org/hunmr/location/CollectedLocationFormatter.java $ROOT_DIR/src/org/hunmr/location/CollectedUsageFormatter.java"
